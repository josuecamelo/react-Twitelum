...
class Tweet extends Component {
    ...
    likeHandler = () => {
        ...
        fetch(`http://twitelum-api.herokuapp.com/tweets/${idDoTweet}/like?X-AUTH-TOKEN=${localStorage
        ...
        return (
            <article className="tweet">
                ...
                <footer className="tweet__footer">
                    {
                        this.props.removivel && <button onClick={this.props.removeHandler} className="btn btn--blue btn--remove">
                        X
                        </button>
                    }
